...
classdef mavlink_msg_local_position_ned < mavlink_msg
    properties (SetAccess = protected)
        ...
        prop_x            = float ( zeros(1,1 ) );
        prop_y            = float ( zeros(1,1 ) );
        prop_z            = float ( zeros(1,1 ) );
        prop_vx           = float ( zeros(1,1 ) );
        prop_vy           = float ( zeros(1,1 ) );
        prop_vz           = float ( zeros(1,1 ) );
    end
    ...
    methods
        ...
        function obj = split_payload( obj )
            ...
            obj.prop_x            = obj.cast_from_bytes( obj.mav_payload(  5:8  ), 'float'  );
            obj.prop_y            = obj.cast_from_bytes( obj.mav_payload(  9:12 ), 'float'  );
            obj.prop_z            = obj.cast_from_bytes( obj.mav_payload( 13:16 ), 'float'  );
            obj.prop_vx           = obj.cast_from_bytes( obj.mav_payload( 17:20 ), 'float'  );
            obj.prop_vy           = obj.cast_from_bytes( obj.mav_payload( 21:24 ), 'float'  );
            obj.prop_vz           = obj.cast_from_bytes( obj.mav_payload( 25:28 ), 'float'  );
        end
        ...
        function obj = set_prop_x( obj, val )
            obj.prop_x = obj.validate_input( val, 'float', 1 );
        end
        ...
        function obj = set_prop_y( obj, val )
            obj.prop_y= obj.validate_input( val, 'float', 1 );
        end
        ...
        function obj = set_prop_z( obj, val )
            obj.prop_z = obj.validate_input( val, 'float', 1 );
        end
        ...
        function obj = set_prop_vx( obj, val )
            obj.prop_vx = obj.validate_input( val, 'float', 1 );
        end
        ...
        function obj = set_prop_vy( obj, val )
            obj.prop_vy = obj.validate_input( val, 'float', 1 );
        end
        ...
        function obj = set_prop_vz( obj, val )
            obj.prop_vz = obj.validate_input( val, 'float', 1 );
        end
